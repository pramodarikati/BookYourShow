...
import com.example.bookyourshow.Adapters.FragmentAdapter;
import com.example.bookyourshow.Fragments.BuzzFragment;
import com.example.bookyourshow.Fragments.HomeFragment;
import com.example.bookyourshow.Fragments.ProfileFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tabLayout.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                tabLayout.getTabAt(tab.getPosition()).getIcon().setColorFilter(getResources().getColor(R.color.light_blue), PorterDuff.Mode.SRC_IN);
                tabLayout.setSelectedTabIndicatorColor(Color.parseColor("#808080"));
                tabLayout.setSelectedTabIndicatorHeight((int) (3 * getResources().getDisplayMetrics().density));
                tabLayout.setTabTextColors(Color.parseColor("#808080"), Color.parseColor("#FF0000"));
            }
