...
public class MovieAdapter extends RecyclerView.Adapter<MovieViewHolder> {
    ...
    public MovieAdapter(List<MoviesModel> moviesModelList, MovieClickListener clickListener) {
...
class MovieViewHolder extends RecyclerView.ViewHolder {
    ...
    public void setData(MoviesModel moviesModel, MovieClickListener clickListener) {
